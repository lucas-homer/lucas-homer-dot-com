...
summary: 'How an enduring framework for knowledge-sharing and decision-making helped one team make more informed, egalitarian decisions—and how you can too.'
image: '/images/unsplash-desert.jpg'
imageAlt: 'Desert Mountain Landscape'
topics: ['Design Systems', 'Component Library']
---

For the better part of the last year, I've been investing heavily in front-end development
and design. When I started my new role, I identified a need for a component library
and created it. Since then, I've learned a lot about style guides, design systems,
component libraries, and their best practices. This post will be a deep-dive on everything
I've learned in the past year.

## Table of Contents

1.  [Why Should You Care?](/blog/test-post#why-should-you-care)
2.  [What is a Style Guide?](/blog/test-post#what-is-a-style-guide)
3.  [What is a Component Library?](/blog/test-post#what-is-a-component-library)
4.  [What is a Design System?](/blog/test-post#what-is-a-design-system)
5.  [Where Should You Begin?](/blog/test-post#where-should-you-begin)
6.  [Building the Design System](/blog/test-post#building-the-design-system)
7.  [Conclusion](/blog/test-post#conclusion)
8.  [Resources](/blog/test-post#resources)
...
A [Monorepo](/blog/monorepo-lerna-yarn-workspaces) allows you to build and publish multiple libraries from a single repo.  While it does solve some very real problems, it also creates others. It's important to understand the pros and cons.
